...
export function useOffline() {
  ...
  }, [status.isOnline, isFirestoreOnline, removeOfflineAction, updateActionRetryCount]);

  // Perform specific offline action
  const performOfflineAction = async (action: OfflineAction) => {
    try {
      switch (action.type) {
        case 'create_post':
  ...
  // Create post from offline data with better error handling
  const createPostFromOffline = async (data: any) => {
    try {
  ...
  // Send message from offline data with better error handling
  const sendMessageFromOffline = async (data: any) => {
    try {
  ...
  // Create event from offline data with better error handling
  const createEventFromOffline = async (data: any) => {
    try {
  ...
  // Create business from offline data with better error handling
  const createBusinessFromOffline = async (data: any) => {
    try {
  ...
  // Update profile from offline data with better error handling
  const updateProfileFromOffline = async (data: any) => {
    try {
